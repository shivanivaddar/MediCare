...
const starterMedicines = [
  { _id: 'starter-paracetamol', name: 'Paracetamol 500mg', category: 'Pain Relief', price: 50, stock: 100, manufacturer: 'MediCare Labs', shop: 'MediCare Central' },
  { _id: 'starter-ibuprofen', name: 'Ibuprofen 400mg', category: 'Pain Relief', price: 85, stock: 64, manufacturer: 'HealthFirst', shop: 'MediCare Central' },
  { _id: 'starter-cetirizine', name: 'Cetirizine 10mg', category: 'Allergy Care', price: 35, stock: 82, manufacturer: 'Wellness Pharma', shop: 'MediCare North' },
  { _id: 'starter-amoxicillin', name: 'Amoxicillin 500mg', category: 'Antibiotics', price: 120, stock: 40, manufacturer: 'TrustMed', shop: 'MediCare North', requiresPrescription: true },
  { _id: 'starter-azithromycin', name: 'Azithromycin 500mg', category: 'Antibiotics', price: 145, stock: 28, manufacturer: 'TrustMed', shop: 'MediCare East', requiresPrescription: true },
  { _id: 'starter-omeprazole', name: 'Omeprazole 20mg', category: 'Digestive Care', price: 70, stock: 76, manufacturer: 'HealthFirst', shop: 'MediCare East' },
  { _id: 'starter-vitamin-d', name: 'Vitamin D3', category: 'Vitamins', price: 180, stock: 55, manufacturer: 'Wellness Pharma', shop: 'MediCare South' },
  { _id: 'starter-ors', name: 'ORS Hydration Salts', category: 'Wellness', price: 25, stock: 150, manufacturer: 'MediCare Labs', shop: 'MediCare South' },
]
